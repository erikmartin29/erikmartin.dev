...
export default async function Home() {
  ...
  return (
    <>
      {/* Hero */}
      <ContentBox innerClassName="py-16">
        <section className="flex flex-col items-center text-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          {profile?.profileImage && (
            <div className="relative overflow-hidden rounded-full shadow-lg w-48 h-48 md:w-60 md:h-60">
              <Image
      ...
      {/* Bio */}
      {profile?.bio && (
        <ContentBox innerClassName="py-12">
      ...
      {/* Experience */}
      <ContentBox innerClassName="py-12 space-y-8">
      ...
      {/* Skills */}
      {skills?.length > 0 && (
        <ContentBox innerClassName="py-12 space-y-6">
      ...
      {/* GitHub Activity */}
      {profile?.socialLinks?.github && (
        <ContentBox innerClassName="py-12 space-y-6" showBottomLine>
